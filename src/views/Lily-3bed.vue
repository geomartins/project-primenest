                ...
                <div class="row ">
                    <div class="col-xl-9 col-lg-8">
                        ...
                        <div class="property-details-slider-info">
                            <h3><span>#14.8m/unit</span> LilyCourt Estate Lagos</h3>
                            <!-- <del>$500</del> -->
                        </div>
                    </div>
                            ...
                            <div class="contact-info">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <p>Address</p>
                                        <span>18, Udi Street, Osborne Foreshore, Ikoyi Lagos</span>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        <p>Phone</p>
                                        <span>(+234) 708 082 9417</span> <br>
                                        <span> (+234) 701 737 0898</span>
                                    </div>
                                </div>
            ...
            <div class="row pd-top-90">
                <div class="col-lg-9">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <div class="single-property-info">
                                    <h5>Bedrooms</h5>
                                    <p><i class="fa fa-bed"></i>03</p>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <div class="single-property-info">
                                    <h5>Bathrooms</h5>
                                    <p><i class="fa fa-bath"></i>03</p>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <div class="single-property-info">
                                    <h5>Area</h5>
                                    <p><img src="assets/img/icons/7.png" alt="img">300 sqm.</p>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <div class="single-property-info">
                                    <h5>Parking</h5>
                                    <p><i class="fa fa-car"></i>02 Outdoor</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="property-news-single-card style-two border-bottom-yellow">
                        ...
                        <p>Lily Court is positioned in a laid-back environment in Ifako-Ijaiye, a fast-developing Lagos suburb. An ultra-modern community which boasts elite amenities and optimum security, its location makes it ideal for young families and the business class.</p>
                        <p> A total 126 units, Lily Court 3-bedroom apartments are based on a 300 sqm. The lounge and dining area covers 31 sqm. The master bedroom claims 18 sqm while the other rooms are 12 sqm large.  All rooms are en-suite. </p>
                        <p> The estate provides each apartment with a dedicated parking area, treated water, and 24 x 7 electricity supply. Sitting in the centre of the park is a recreational complex which allows easy access to daily essentials, personal or social, thereby improving your living experience.  </p>
                        <!-- <a href="#">Read More</a> -->
                    </div>
                    <div class="property-news-single-card style-two border-bottom-yellow">
                        <h4>Base Floor Plan</h4>
