                ...
                <div class="row ">
                    <div class="col-xl-9 col-lg-8">
                        ...
                        <div class="property-details-slider-info">
                            <h3><span>#5m/unit</span> Bricks Court Sagamu</h3>
                            <!-- <del>$500</del> -->
                        </div>
                    </div>
            ...
            <div class="row pd-top-90">
                <div class="col-lg-9">
                    ...
                    <div class="property-news-single-card style-two border-bottom-yellow">
                        ...
                        <p>Set in two rapidly developing suburbs Ogun State, the Bricks Court Estate is a modern settlement equipped with top-of-the-class facilities, and which provides the level of comfort and serenity you experience in the high-end areas of the state.</p>
                        <p>  Bricks Court Estate houses 100 units of 3-bedroom bungalows. Each apartment has a dedicated parking area, treated water supply, and all amenities that guarantee convenience and a luxurious lifestyle.</p>
                        <!-- <a href="#">Read More</a> -->
                    </div>
                    <div class="property-news-single-card style-two border-bottom-yellow">
                        <h4>Base Floor Plan</h4>
